...
походження цифри лишалося видимим.
...
**Обмеження 40% на критерій не є бізнес-правилом.** До підтвердження Мариною
його слід зробити налаштуванням або прибрати зовсім. Обов'язкове правило одне:
**сума ваг = 100%**.
...
Дванадцять ухвалених рішень (Р-01…Р-12) і шість позицій, що лишаються
відкритими (В-01…В-06), — у `CHANGELOG-2026-09-25.md` §3 і §3a.
