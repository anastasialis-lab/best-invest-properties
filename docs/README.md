...
Дванадцять питань, піднятих під час звірення, закрито. Стисло:
...
| В-05 | Чи лишати обмеження 40% на вагу критерію | Марина |
| В-06 | Мінімальна кількість comparable listings для затвердження вибірки | Марина / аналітик |
